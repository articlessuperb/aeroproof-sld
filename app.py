...
if not st.session_state["auth"]:
    ...
    with col2:
        ...
        # Use a default if secrets are missing so it doesn't crash
        correct_pass = st.secrets["auth"].get("director_pass", "admin")
...
# --- 4. MAIN DASHBOARD (NATIVE LAYOUT) ---
st.title("🛡️ AeroProof Command Center")
st.caption(f"Status: ONLINE | Mission: GBR-gc284pmztcrt-7-2ot | User: Director")
